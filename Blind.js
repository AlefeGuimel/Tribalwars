...
var scriptConfig = {
    ...
    translations: {
        ...
        pt_BR: {
        'Frontline Stacks Planner': 'Planejador de Stacks da Linha de Frente',
        'Help': 'Ajuda',
        'There was an error!': 'Ocorreu um erro!',
        'Redirecting...': 'Redirecionando...',
        'Error fetching player incomings!': 'Erro ao buscar os ataques recebidos!',
        'You can only run this script if you are member of a tribe!': 'Você só pode executar este script se for membro de uma tribo!',
        'Tribe members have not shared their troop counts with tribe leadership!': 'Os membros da tribo não compartilharam a contagem de tropas com a liderança!',
        'Start typing and suggestions will show ...': 'Comece a digitar e as sugestões aparecerão...',
        'Select enemy tribes': 'Selecione as tribos inimigas',
        'Distance': 'Distância',
        'Stack Limit': 'Limite de Stack',
        'Scale down per field (k)': 'Redução por campo (k)',
        'Required Stack Amount': 'Quantidade de Stack Necessária',
        'Calculate Stacks': 'Calcular Stacks',
        'Find Backline Stacks': 'Encontrar Stacks da Retaguarda',
        'Fill all the required fields!': 'Preencha todos os campos obrigatórios!',
        'You need to select an enemy tribe!': 'Você precisa selecionar uma tribo inimiga!',
        'Village': 'Aldeia',
        'Map': 'Mapa',
        'Pop.': 'Pop.',
        'Distance': 'Distância',
        'Missing Troops': 'Tropas Faltantes',
        'All villages have been properly stacked!': 'Todas as aldeias foram stackadas corretamente!',
        'Export': 'Exportar',
        'No stack plans have been prepared!': 'Nenhum plano de stack foi preparado!',
